...
<!-- Mirrored from kute-themes.com/html/kuteshop/html/Login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jun 2020 15:40:41 GMT -->
@include('users.includes.nav')

<body class="index-opt-1 catalog-product-view catalog-view_op1 page-login">
                        ...
                        <div class="block-nav-menu">
                            ...
                            <ul class="ui-menu">
                                        ...
                                        <ul>
                                            <li class="col-md-3">
                                                ...
                                                <ul class="list-submenu">
                                                    <li><a href="home1.php">Home page 1</a></li>
                                                    <li><a href="home2.php">Home page 2</a></li>
                                                    <li><a href="home3.php">Home page 3</a></li>
                                                    <li><a href="home4.php">Home page 4</a></li>
                                                    <li><a href="home5.php">Home page 5</a></li>
                                                    <li><a href="home6.php">Home page 6</a></li>
                                                    <li><a href="home7.php">Home page 7</a></li>
                                                </ul>
                                            </li>
                                            <li class="col-md-3">
                                                <strong class="title"><a href="#"><span>Home </span></a></strong>
                                                <ul class="list-submenu">
                                                    <li><a href="home8.php">Home page 8</a></li>
                                                    <li><a href="home9.php">Home page 9</a></li>
                                                    <li><a href="home10.php">Home page 10</a></li>
                                                    <li><a href="home11.php">Home page 11</a></li>
                                                    <li><a href="index.blade.php">Home page 12</a></li>
                                                    <li><a href="home13.php">Home page 13</a></li>
                                                    <li><a href="home14.php">Home page 14</a></li>
                                                </ul>
                                            </li>
                                            <li class="col-md-3">
                                                ...
                                                <ul class="list-submenu">
                                                    ...
                                                    <li><a href="cart.blade.php">Order</a></li>
                                                </ul>
                                            </li>
                                            <li class="col-md-3">
                                                <strong class="title"><a href="#"><span>Page </span></a></strong>
                                                <ul class="list-submenu">
                                                    <li><a href="products.blade.php">Category 1</a></li>
                                                    <li><a href="Category2.php">Category 2</a></li>
                                                    <li><a href="Product1.php">Product 1</a></li>
                                                    <li><a href="Product2.php">Product 2</a></li>
                                                    <li><a href="product-details.blade.php">Product 3</a></li>
                                ...
                                <li class="parent parent-submenu">
                                    <a href="Contact.blade.php"> Fashion  </a>
                                    <span class="toggle-submenu"></span>
                                ...
                                <li class="parent parent-megamenu">
                                    <a href="Contact.blade.php">Digital </a>
                                    <span class="toggle-submenu"></span>
                                    <div class="megamenu drop-menu">
                                        <ul>
                                            <li class="col-md-3">
