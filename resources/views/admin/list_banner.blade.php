                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    @foreach($banners as $banner)
                                        <tr>
                                            ...
                                            <td><a href="{{url('edit_banner/'.$banner->id)}}"><span class="label label-rouded label-warning"> Edit</span></a> || <a href="{{ route('deleteBanner', ['id' => $banner->id]) }}"> <span class="label label-rounded label-danger">Delete</span></a></td>
                                            <td></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
