                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form method="post" action="{{ route('categoryUpload') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputImage">Upload Category</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-text"></i></div>
                                                <input type="text" class="form-control" id="exampleInputImage" name="category">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputImage">Upload Category Image</label>
                                            <div class="input-group">
