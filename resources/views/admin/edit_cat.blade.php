                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13"> Upload Category</p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form method="post" action="{{url('editCategory/'.$category->id)}}">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputImage">Upload Category</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-image"></i></div>
                                                <input type="text" class="form-control" id="exampleInputImage" name="category" value="{{$category->category_name}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-image"></i></div>
                                                <div class="white-box">
                                                    <img src="/images/{{$category->image}}" alt="banner" style="height: 100px; width: 100px;"/>
                                                </div>
                                                <input type="file" class="form-control" id="exampleInputImage" name="image" value="{{$category->image}}">
                                            </div>
                                        </div>
