            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">View Ministries</h4>
                    </div>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td><img src="/images/{{$category->image}}" alt="banner" style="height: 50px; width: 50px;"/></td>
                                            <td><a href="{{url('edit_cat/'.$category->id)}}"><span class="label label-rouded label-warning"> Edit</span></a> || <a href="{{ route('deleteCategory', ['id' => $category->id]) }}"> <span class="label label-rouded label-danger">Delete</span></a></td>
                                            <td></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
